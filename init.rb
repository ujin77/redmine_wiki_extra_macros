Redmine::Plugin.register :redmine_wiki_extra_macros do
    ...
    author 'Eugene M.'
    description 'Redmine plugin adds a macro to Wiki Redmine. {{project_id}}, {{project_name}}, {{project_email(example.com)}}, {{current_user_mail}}'
    version '0.0.2'
    ...
    Redmine::WikiFormatting::Macros.register do
        desc "This plugin adds a macro to Wiki Redmine. <pre>{{project_id}} {{project_name}} {{project_email(example.com)}} {{current_user_mail}}</pre>"
